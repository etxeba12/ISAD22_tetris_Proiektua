...
class aukerenPantaila():
    ...
    def __init__(self):
        ...
        izenaErabiltzaile = tk.Entry(self.window, justify=tk.CENTER, textvariable=tk.StringVar(value=listaDatuak[0]), state=tk.DISABLED,borderwidth=3, relief="sunken", width=25 )
        ...
        puntuazioErabiltzaile = tk.Entry(self.window, justify=tk.CENTER, textvariable=tk.StringVar(value=listaDatuak[2]), state=tk.DISABLED,borderwidth=3, relief="sunken", width=25 )
        ...
        maila = tk.Entry(self.window, justify=tk.CENTER, textvariable=tk.StringVar(),state=tk.NORMAL, borderwidth=3, relief="sunken", width=25)
        maila.pack()
    ...
    def jokatuleioa(self,Maila):
        #Aukeratutako mailaren arabera, zailtasun desberdinak izango ditu jokoak
